...
if [[ "$ismaster" == "true" ]]; then
    ...
    REDSQIRL_TAR=redsqirl-2.7.3-1.4-tomcat.tar.gz
    REDSQIRL_DOWNLOAD_PATH=/opt/${REDSQIRL_TAR}
    REDSQIRL_PATH=/opt/redsqirl-2.7.3-1.4
    REDSQIRL_PORT=8842
    cd /opt
    sudo wget https://s3-eu-west-1.amazonaws.com/redsqirl/v1.4/redsqirl-2.7.3-1.4-tomcat.tar.gz
